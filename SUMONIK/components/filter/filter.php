                    ...
                    <div class="filter-select">
                        <div>
                            ...
                            <select id="<?php echo $name ?>"
                                    name="<?php echo $name ?>"
                                    class="last-items-dropdown input-text">
                ...
                <?php } else { ?>
                    ...
                    <div class="wrapper-field range-field">
                        <div class="price-slider-wrapper">
                            <span class="label-field"><?php echo lang('applyFilterPrice'); ?></span>
                            <ul class="price-slider-list">
                                <li>
                                    <input type="text"
                                           id="minCost"
                                           class="price-input start-<?php echo $prop['class'] ?>  price-input input-text"
                                ...
                                <li>
                                    <input type="text"
                                           id="maxCost"
                                           class="price-input end-<?php echo $prop['class'] ?>  price-input input-text"
