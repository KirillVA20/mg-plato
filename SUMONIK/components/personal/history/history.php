                                ...
                                <div class="order-settings">
                                    <div class="c-history__row">
                                        <a href="#js-modal__reason"
                                           class="c-button c-button--border close-order input-button"
                                           id="<?php echo $order['id'] ?>"
                                  ...
                                  if (empty($urInfo['inn'])) { ?>
                                      <div class="c-history__row">
                                          <a href="#js-modal__payment"
                                             class="c-button c-button--border change-payment input-button"
                                             id="<?php echo $order['id'] ?>"
                                             date="<?php echo date('d.m.Y', strtotime($order['add_date'])) ?>"
                                             data-number="<?php echo $order['number'] != '' ? $order['number'] : $order['id']; ?>">
                    ...
                    <div class="c-modal__wrap">
                        <div class="c-modal__content">
                            ...
                            <div class="c-form"
                                ...
                                <div class="c-form__row">
                                    <select class="order-changer-pay input-text">
                                      <?php
                                ...
                                <div class="c-form__row">
                                    <button type="submit"
                                            class="c-button change-payment-btn default-btn input-button"><?php echo lang('apply'); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="c-modal__wrap">
                        <div class="c-modal__content">
                            ...
                            <div class="c-form"
                                 id="openModal">
                                <div class="c-form__row">
                                     <textarea class="reason-text input-text"
                                               name="comment_textarea"
                                               placeholder="<?php echo lang('personalOrderClose1'); ?>"></textarea>
                                </div>
                                <div class="c-form__row">
                                    <button type="submit"
                                            class="c-button close-order-btn input-button"><?php echo lang('send'); ?></button>
                                </div>
                                <div class="order-number"
