<ul class="c-order__list form-list">
    ...
    <li class="c-order__list--width c-order__list--item">
        <select name="customer" aria-label="<?php echo lang('orderPayer'); ?>">
