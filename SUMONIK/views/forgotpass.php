...
<div class="container forgotpass">
  ...
  <?php switch ($data['form']) {
      ...
      case 1: ?>
          <div class="forgotpass__form-title">
            <?php echo lang('enterEmail'); ?>
          </div>
          <form action="<?php echo SITE ?>/forgotpass"
                method="POST">

              <input class="forgotpass__input input-text"
                     type="text"
                     name="email"
                     placeholder="Email"
                     required>

              <input class="forgotpass__button input-button"
                     type="submit"
                     name="forgotpass"
